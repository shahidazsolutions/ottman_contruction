                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row gx-3" action="{{ route('form.transfer.update',$transfer->id) }}" method="post" id="">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-md-">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter party A nominee" value="{{ $transfer->old_customer_nominee }}" name="old_customer_nominee">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Enter party A recieve payment" value="{{ $transfer->old_customer_payment }}" name="old_customer_payment">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number"  class="form-control" placeholder="Enter party A cnic number" value="{{ $transfer->new_customer_nic }}" name="old_customer_nic">
                               ...
                               @endforeach
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label>Nominee <span class="text-danger">*</span> </label>
                                            <input type="text" class="form-control" placeholder="Enter party B nominee" value="{{ $transfer->new_customer_nominee }}" name="new_customer_nominee">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Payment Recieve <span class="text-danger">*</span> </label>
                                            <input type="number" class="form-control" placeholder="Enter party B recieve payment" value="{{ $transfer->new_customer_payment }}" name="new_customer_payment">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Cnic <span class="text-danger">*</span> </label>
                                            <input type="number" class="form-control" placeholder="Enter party B cnic number" value="{{ $transfer->new_customer_nic }}" name="new_customer_nic">
