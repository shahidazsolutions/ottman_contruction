                    ...
                    <div class="col-lg-12">
                        <div class="card"> 
                            ...
                            <div class="card-body admin-form">
                                <form class="row gx-3" method="POST" action="{{route('insert_supplier') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label>NIC</label>
                                        <input type="text" class="form-control @error('nic') is-invalid @enderror" name="nic" value="{{ old('nic') }}">
                                        @error('nic')
                                            <span class="text-danger">{{ $message }}</span>
                                        @endif
                                    </div>
