                    ...
                    <div class="property-2 row column-sm property-label property-grid px-3">
                        <table class="table table-bordered table-hovered table-striped " id="datatable">
                            <thead>
                                ...
                                <tbody>
                                    @foreach ($contractor as $key=> $data)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $data->email }}</td>
                                            <td>{{ $data->address }}</td>
                                            <th>{{ formatAmount($data->contracts()->sum('amount') - $data->payments()->sum('amount') ) }}</th>
                                            <td>

                                                <a class="btn btn-sm btn-dashed btn-pill color-6" href="{{ route('contractor.show',$data->id) }}">
                                                   <i class="fa-solid fa-eye"></i>

                                                </a>

                                                <a class="btn btn-sm btn-dashed btn-pill color-6" href="{{ route('contractor.edit',$data->id) }}">
                                        ...
                                        <div class="modal fade" id="delete{{ $data->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="{{route('contractor.delete',$data->id)}}">
