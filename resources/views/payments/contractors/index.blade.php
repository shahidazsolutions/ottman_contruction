            ...
            <div class="col-lg-12">
                <div class="card border">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        <h5>All Payments</h5>
                        <a href="{{ route('contractor.payments.create') }}" class="btn btn-primary float-end">Add
                            Payment</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a  href="{{ route('contractor.payments.invoice',$payment->id) }}" class="btn btn-dashed-second btn-pill color-1">
